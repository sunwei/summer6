...
import { HengshanjScene } from './scenes/HengshanjScene.js';
import { TaishanScene } from './scenes/TaishanScene.js';
...
const config = {
  ...
  scene: [BootScene, MenuScene, WudangScene, SongshanScene, HuashanScene, HengshanjScene, TaishanScene, HUDScene],
};
